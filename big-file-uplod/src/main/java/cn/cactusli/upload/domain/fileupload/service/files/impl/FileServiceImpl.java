...
import cn.cactusli.upload.domain.fileupload.model.entity.FileCallable;
...
import cn.cactusli.upload.types.enums.FileCheckMd5Status;
...
public class FileServiceImpl implements FileService {
    ...
    public FileUpload checkFileMd5(FileUploadRequest param) throws IOException {
        ...
        if (uploadProgressObj == null) {
            FileUpload fileMd5DTO = FileUpload.builder().path(param.getPath()).code(FileCheckMd5Status.FILE_NO_UPLOAD.getValue()).build();
            return fileMd5DTO;
        }
